/**
 * modusbrain salience — Pages recently touched, ranked by emotional + activity salience.
 *
 ...
 *
 * Usage:
 *   modusbrain salience                            # top 20 over last 14 days
 *   modusbrain salience --days 7                   # narrower window
 *   modusbrain salience --kind personal            # filter to slug-prefix
 *   modusbrain salience --json                     # JSON for agents
 */
...
const HELP = `Usage: modusbrain salience [options]
