/**
 * modusbrain bench publish — turn a captured-run NDJSON into a baseline file (v0.41).
 *
 ...
 * of `modusbrain eval export` and writes a `*.baseline.ndjson` file with:
 ...
 *
 * Usage:
 *   modusbrain bench publish --from <captured.ndjson> --to <X.baseline.ndjson>
...
function printHelp(): void {
  console.log(`modusbrain bench publish — write a baseline file from captured queries

Usage:
  modusbrain bench publish --from <captured.ndjson> --to <X.baseline.ndjson> [flags]

Required:
  --from FILE                    Input NDJSON from \`modusbrain eval export\`
...
Examples:
  ...
  modusbrain bench publish --from /tmp/captured.ndjson --to ~/.modusbrain/baselines/personal.baseline.ndjson --label "personal-2026-05"
