/**
 * modusbrain publish — Generate shareable HTML from brain markdown pages.
 *
 ...
 *
 * Usage:
 *   modusbrain publish <page-path>                         # local HTML file
 *   modusbrain publish <page-path> --password              # auto-generated pw
 *   modusbrain publish <page-path> --password "secret"     # custom pw
 *   modusbrain publish <page-path> --out /tmp/share.html   # custom output
 *   modusbrain publish <page-path> --title "Custom Title"  # override title
 */
...
export async function runPublish(args: string[]) {
  ...
  if (!inputPath) {
    console.error('Usage: modusbrain publish <page.md> [--password ["secret"]] [--title "Title"] [--out path]');
    console.error('');
