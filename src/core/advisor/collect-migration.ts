    ...
    return [
      {
        ...
        detail: 'Newer modusbrain code assumes the latest schema; an un-migrated brain can fail or under-perform.',
        fix: { command_argv: ['modusbrain', 'apply-migrations', '--yes'], dispatch_id: 'apply_migrations' },
        collector: 'migration',
        ask_user: true,
      },
    ];
