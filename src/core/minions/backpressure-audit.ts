 ...
 * doctor scan.
 *
 * File: `~/.modusbrain/audit/backpressure-YYYY-Www.jsonl` (override dir via
 * `MODUSBRAIN_AUDIT_DIR` for container/sandbox deployments where `$HOME` is read-only).
 *
 * `modusbrain jobs stats` will surface coalesce counts from this file in a v0.19.2+
...
/** Honors `MODUSBRAIN_AUDIT_DIR` for container/sandbox deployments. */
