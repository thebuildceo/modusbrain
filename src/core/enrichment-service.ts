...
export async function enrichEntity(
  ...
  try {
    await engine.addTimelineEntry(slug, { // modusbrain-allow-direct-insert: auto-timeline reconciliation triggered by entity reference in source markdown
  ...
  try {
    await engine.addLink(slug, request.sourceSlug, `Entity mention from ${request.sourceSlug}`); // modusbrain-allow-direct-insert: auto-link reconciliation triggered by entity reference in source markdown
