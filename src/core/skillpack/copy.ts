/**
 * skillpack/copy.ts — shared file-copy primitive for scaffold (modusbrain→host)
 * and harvest (host→modusbrain).
 *
 ...
 * secrets into modusbrain's tree or escaping the intended skill dir.
 *
