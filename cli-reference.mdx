...
<Warning>
`modusbrain skill <name>` without a subcommand fetches host skillpack instructions (GBrain behavior). Use `opskill` for operational skills.
</Warning>
...
## Core GBrain commands

ModusBrain also includes the full GBrain engine:
