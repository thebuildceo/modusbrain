...
### DNS for [modusbrain.com](http://modusbrain.com)
...
- [x] Create GitHub org/repo `modusbrain`
- [ ] Push rebranded code; tag `v1.0.0`
- [x] Deploy marketing site to Vercel
- [x] Connect Mintlify → docs.modusbrain.com
...
| Enterprise email   | [hello@modusbrain.com](mailto:hello@modusbrain.com)       |
| Security           | [security@modusbrain.com](mailto:security@modusbrain.com) |
