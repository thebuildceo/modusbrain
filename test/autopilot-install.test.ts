/**
 * Tests for env-aware `modusbrain autopilot --install`.
 *
 * Covers:
...
beforeEach(() => {
  ...
  tmp = mkdtempSync(join(tmpdir(), 'modusbrain-install-test-'));
...
// exported MODUSBRAIN_DATABASE_URL or {OPENAI,ANTHROPIC}_API_KEY in zshrc and
