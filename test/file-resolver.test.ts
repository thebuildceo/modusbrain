...
describe('file-resolver', () => {
  ...
  beforeAll(() => {
    brainRoot = mkdtempSync(join(tmpdir(), 'modusbrain-resolver-'));
    storageDir = mkdtempSync(join(tmpdir(), 'modusbrain-resolver-storage-'));
...
describe('parseRedirect', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'modusbrain-redirect-'));
  });
...
describe('parseMarker', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'modusbrain-marker-'));
  });
